...
const (
	...
	ErrorMsg401UnAuthorized = "The request was a legal request, but the server is refusing to respond to it. " +
	...
	ErrorMsg404NotFound        = "The requested page could not be found but may be available " +
		"again in the future"
	ErrorMsg405MethodNotAllowed = "A request was made of a page using a request method not supported " +
		"by that page"
	...
	ErrorMsg411LengthRequired              = "The \"Content-Length\" is not defined. The server will not accept " +
	...
	ErrorMsg414RequestURLToLarge  = "The server will not accept the request, because the URI is too long. " +
		"Occurs when you convert a POST request to a GET request with a long query information"
	ErrorMsg415UnsupportedMediaType = "The server will not accept the request, " +
		"because the media type is not supported"
	ErrorMsg416RangeNotSatisfiable = "The client has asked for a portion of the file, " +

...
func NewRabbitmq(config rmqpc.ConnectionConfig, eventRouter types.EventRouter) (*rmqpc.Connection, error) {
	cfg := rmqpc.Config{
...
func bindingKeys(eventRouter types.EventRouter) []types.Event {
	var bKeys []types.Event

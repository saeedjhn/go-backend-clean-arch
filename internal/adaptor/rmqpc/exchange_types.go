...
const (
	// DirectExchange routes messages to queues based on an exact matching between the message's routing key and the
	// queue's binding key. This type is used when you need to deliver messages to specific queues based on exact
	// routing keys.
	...
	// TopicExchange routes messages to queues based on pattern matching between the routing key and the queue's
	// binding key. This allows for more complex routing, including wildcards.
